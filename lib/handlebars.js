...
handlebars.registerHelper( "contentBox", function( options ) {
	var classes = "content-box";

	if ( options.data.activeUser && options.hash.user &&
			options.hash.user.id === options.data.activeUser.id ) {
		classes += " content-box-current-user";
	}
